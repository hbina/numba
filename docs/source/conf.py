...
latex_documents = [
    ("index", "numba.tex", "Numba Documentation", "Anaconda", "manual"),
]
...
man_pages = [("index", "numba", "Numba Documentation", ["Anaconda"], 1)]
...
def _autogenerate():
    ...
    gen_lower_listing(os.path.join(basedir, "developer/autogen_lower_listing.rst"))
    ...
    for package in ["builtins", "math", "cmath", "numpy"]:
        write_listings(
            ...
            filename=os.path.join(
                basedir,
                "developer",
                "autogen_{}_listing".format(package),
            ),
            output_format="rst",
        )
