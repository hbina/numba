...
def cpu_atomic_fetch_add_impl(context, builder, sig, args):
    """
...
def cpu_atomic_fetch_add_array_impl(context, builder, sig, args):
    """
...
def cpu_atomic_compare_and_swap_array_impl(context, builder, sig, args):
    """
