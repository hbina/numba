...
from numba.core.llvm_bindings import create_pass_builder, create_pass_manager_builder
...
class _CFG(object):
    ...
    def pretty_printer(
        ...
        for obj in jzon["objects"]:
            ...
            fmtheader = (
                '<tr><td BGCOLOR="{}" BORDER="1" ALIGN="left" COLSPAN="{}">{}</td></tr>'
            )
            new_lines.append(
                fmtheader.format(
            ...
            fmt = (
                '<tr><td BGCOLOR="{}" BORDER="0" ALIGN="left" COLSPAN="{}">{}</td></tr>'
            )
