...
class TestArrayAnalysis(TestCase):
    ...
    def _compile_and_test(
        self, fn, arg_tys, asserts=None, equivs=None, idempotent=True
    ):
        """
    ...
    def test_base_cases(self):
        ...
        self._compile_and_test(
            test_arr_in_tup, (types.intp,), equivs=[self.with_equiv("A", "B")]
        )
    ...
    def test_numpy_calls(self):
        ...
        self._compile_and_test(
            test_global_tuple, (), equivs=[self.with_equiv("a", "b")], asserts=None
        )
